...
grid_shape = [4 dim];                     % Do not change
nsamples = 1000;
file = ['miniexperiment_1/miniexperiment_1_dim4x' int2str(dim) '.mat'];
...
for trial = 1:ntrials % can use parfor loop for parallelization
    ...
    %% Display the values
    fprintf(['dim: %5d, mle sq_err: %10.4f, mle time: %10.4f, mpf sq_err: ' ...
             '%10.4f, mpf time: %10.4f\n'], ...
            dim, mle_sq_err, mle_t, mpf_sq_err, mpf_t);
end
